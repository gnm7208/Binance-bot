...
1. bash scripts/mexc.sh account
2. bash scripts/mexc.sh positions
3. bash scripts/mexc.sh orders
4. For each non-USDT position: bash scripts/mexc.sh price <TICKER>USDT
...
⚠️  X trades placed this week (max 15)
